...
print:
	...
	{
	char *javaprint = (char *) malloc(1 + strlen($<strval>1)+ strlen($<strval>2)+ strlen($<strval>3)+
	strlen($<strval>4)+ strlen($<strval>5)+ strlen($<strval>6)+ strlen($<strval>7)+ strlen($<strval>8)+
	strlen($<strval>9));
	strcpy(javaprint,$<strval>1);
	strcat(javaprint,$<strval>2);
	strcat(javaprint,$<strval>3);
	strcat(javaprint,$<strval>4);
...
metodo:
	...
	{
	char *method = (char *) malloc(1 + strlen($<strval>1)+ strlen($<strval>2)+ strlen($<strval>3)+
	strlen($<strval>4)+ strlen($<strval>5));
	strcpy(method,$<strval>1);
	strcat(method,$<strval>2);
	strcat(method,"\n");
	strcat(method,$<strval>3);
	strcat(method,"\n");
	strcat(method,$<strval>4);
	strcat(method,"\n");
	strcat(method,$<strval>5);
